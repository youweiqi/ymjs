...
<!--    <div class="goods-form">-->
        <?php $form = ActiveForm::begin([
            'options' => ['class' => 'form-horizontal','readonly'=>'readonly'],
            'action' => Url::to(['/goods/goods/create-goods']),
            'fieldConfig' => [
        ...
        <div class="form-group">
            ...
            <div class="col-xs-9">
                <?= Html::button('下一步', ['class' => $model->isNewRecord ? 'btn btn-success one-to-two' : 'btn btn-primary next-one','type'=>'button']) ?>
            </div>
        ...
        <div class="norms-warp two-step" style="display: none;">
            ...
            <div class="product-form">
                <div class="form-group  spec_pool" style="margin-left: 12px;margin-right: 12px;">
                    <div class="spec_input"  style="">
                        <div class="one_spec_select one_spec_select_1 clearfix" data-index="0">
            ...
            <div class="spec_table_norms_box" style="display: none">
                <table class="table table-bordered">
                    <table id="spec_norms_table" class="table table-bordered no-footer" style="margin-top: 20px; display: block;">
        ...
        <div class="banner-warp three-step" style="display: none">
            ...
            <div class="slide-imgs">
                <div class="img-item">
                    <div class="change_img_div act_img_div">
                        ...
                        <img src="../../statics/goods/images/600_400.png" class="thumbnail" name="goods_loopimgs[]" id="post_photo_pre1">
                        <input type="file" class="upload_img_banner" >
                        <input type="hidden" class="upload_img_banner_hidden" name="upload_img[]">
                    </div>
                </div>
                <div class="img-item">
                    <div class="change_img_div act_img_div">
                        <span class="change_img_btn"  ><i class="fa fa-chain"></i></span>
                        <span class="del_img close-modal" id="del_img_2" >×</span>
                        <img src="../../statics/goods/images/600_400.png" name="goods_loopimgs[]"  class="thumbnail thumbnail-2" id="post_photo_pre2">
                        <input type="file" class="upload_img_banner" >
                        <input type="hidden" class="upload_img_banner_hidden" name="upload_img[]">
                    </div>
                </div>
                <div class="img-item">
                    <div class="change_img_div act_img_div">
                        <span class="change_img_btn"  ><i class="fa fa-chain"></i></span>
                        <span class="del_img close-modal" id="del_img_3" >×</span>
                        <img src="../../statics/goods/images/600_400.png" name="goods_loopimgs[]" class="thumbnail thumbnail-3" id="post_photo_pre3">
                        <input type="file" class="upload_img_banner" >
                        <input type="hidden" class="upload_img_banner_hidden" name="upload_img[]">
                    </div>
                </div>
                <div class="img-item">
                    <div class="change_img_div act_img_div">
                        <span class="change_img_btn"  ><i class="fa fa-chain"></i></span>
                        <span class="del_img close-modal" id="del_img_4">×</span>
                        <img src="../../statics/goods/images/600_400.png" name="goods_loopimgs[]"  class="thumbnail thumbnail-4" id="post_photo_pre4">
                        <input type="file" class="upload_img_banner" >
                        <input type="hidden" class="upload_img_banner_hidden" name="upload_img[]">
                    </div>
                </div>
                <div class="img-item">
                    <div class="change_img_div act_img_div">
                        <span class="change_img_btn"  ><i class="fa fa-chain"></i></span>
                        <span class="del_img close-modal" id="del_img_5" >×</span>
                        <img src="../../statics/goods/images/600_400.png" name="goods_loopimgs[]"  class="thumbnail thumbnail-5" id="post_photo_pre5">
                        <input type="file" class="upload_img_banner">
                        <input type="hidden" class="upload_img_banner_hidden" name="upload_img[]">
                    </div>
                </div>
                <div class="img-item">
                    <div class="change_img_div act_img_div">
                        <span class="change_img_btn"  ><i class="fa fa-chain"></i></span>
                        <span class="del_img close-modal" id="del_img_6" >×</span>
                        <img src="../../statics/goods/images/600_400.png" name="goods_loopimgs[]"  class="thumbnail thumbnail-6" id="post_photo_pre6">
                        <input type="file" class="upload_img_banner" >
                        <input type="hidden" class="upload_img_banner_hidden" name="upload_img[]">
                    </div>
                </div>
            ...
            <div class="clearfix">
                ...
                <div class="last-upload-warp">
                    ...
                    <ul class="last-items-img mobile-img-list clearfix"></ul>
                </div>
            </div>
            <!--banne图、详情图提交-->
            <div class="product-buttons">
