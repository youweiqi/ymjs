...
/**
 * ComplainSearch represents the model behind the search form of `common\models\AfterSales`.
 */
class ComplainSearch extends AfterSales
{
    public $user_name;
    ...
    public function rules()
    {
        return [
            ...
            [['order_info_sn', 'product_bn', 'after_sn', 'user_refund_reason', 'user_first_reason', 'supplementary_reason', 'img_proof1', 'img_proof2', 'img_proof3', 'store_refuse_reason', 'store_refuse_reason1', 'courier_company', 'courier_company_en','app_id','courier_number', 'create_time', 'update_time', 'refund_id'], 'safe'],
