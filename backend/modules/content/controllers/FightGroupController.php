...
use backend\modules\content\models\search\FightGroupSearch;
...
/**
 * FightGroupController implements the CRUD actions for Activity model.
 */
class FightGroupController extends Controller
{
    ...
    {
        $searchModel = new FightGroupSearch();
