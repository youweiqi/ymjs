...
class ProductSearch extends Product
{
    ...
    {
        return [
            [['id', 'goods_id', 'supply_threshold', 'is_stock_warn', 'is_del', 'status'], 'integer'],
            [['spec_info', 'spec_desc', 'spec_name', 'bar_code', 'product_bn', 'create_time', 'update_time'], 'safe'],
            [['id','goods_name','bar_code','product_bn'],'trim']
        ];
    }
