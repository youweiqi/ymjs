...
/**
 * AllocateSearch represents the model behind the search form of `common\models\OrderInfo`.
 */
class AllocateSearch extends OrderInfo
{
    public $user_name;
    ...
    public function search($params)
    {
        $query = OrderInfo::find()
            ->where(['and',['order_info.status' =>'2'],['active_status'=>'0']])
