...
/**
 * GoodsApiSearch represents the model behind the search form of `common\models\Goods`.
 */
class GoodsApiSearch extends Goods
{
    public $brand_name;
    ...
    */
    ...
    public function doExport($prefix, $params)
    {
        ...
        $title = [
            '货号Id','商品Id','商品编码', '供应链商品Id', '商品名称','二级分类',
        ...
        $callback = function ($pageNum, $limit) use ($query) {
            ...
            foreach ($mateData as $k => $model) {
                ...
                $line = [
                    ...
                    empty($good_value[$model->goods_id])?'': $good_value[$model->goods_id]['api_goods_id'],
