...
/**
 * UserJournalSearch represents the model behind the search form of `common\models\UserJournal`.
 */
class UserJournalSearch extends UserJournal
{
    public $user_name;
    /**
     * @inheritdoc
