...
namespace common\widgets\link_pager;
...
class LinkPager extends \yii\widgets\LinkPager{
     ...
     */
    public $template = '{pageButtons} {customPage} {pageSize}';
    ...
    public $options = ['class' => 'pagination','style'=>'display:inline'];
     ...
     * Jump
     */
    public $customPageBefore = '<b>跳转到第</b>';
    /**
     * Page
     */
    public $customPageAfter = '<b>页  每页最多显示</b>';
    ...
    public $prevPageCssClass = 'prev hidden-xs';
    public $nextPageCssClass = 'next hidden-xs';
