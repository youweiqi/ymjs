...
/**
 * GroupSearch represents the model behind the search form of `common\models\OrderInfo`.
 */
class GroupSearch extends OrderInfo
{
    public $user_name;
    ...
    {
        $team_id = Common::getPower();
        $query = OrderInfo::find()
        ->where(['and',['=','team_id',$team_id],['=','user_id','']]);
