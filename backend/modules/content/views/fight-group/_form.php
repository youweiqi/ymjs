...
<div class="activity-form">
    ...
    <?=  $form->field($model, 'store_id')->label('门店')->widget(Select2::classname(), [
    ...
    <?= $form->field($model, 'type')->radioList(['4'=>'拼团',]) ?>
        ...
        <table id="activity_detail" class="table table-striped">
            ...
            <?php if (isset($activity_details)&&!empty($activity_details)){
                foreach ($activity_details as $activity_detail){
                    echo "<tr>
                <td class='col-sm-3' style='text-align:center'>$activity_detail->product_id</td>
                <td class='col-sm-3' style='text-align:center'>$activity_detail->product_bn</td>
                <td class='col-sm-3' style='text-align:center' onclick='tdclick(this)'>$activity_detail->inventory_num</td>
                <td class='hidden col-sm-1'>$activity_detail->inventory_id</td>
                <td class='col-sm-2' style='text-align:center; ' onclick='deletetr(this)'>
