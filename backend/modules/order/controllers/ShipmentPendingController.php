...
use backend\modules\order\models\search\ShipmentPendingSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ShipmentPendingController implements the CRUD actions for OrderInfo model.
 */
class ShipmentPendingController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new ShipmentPendingSearch();
