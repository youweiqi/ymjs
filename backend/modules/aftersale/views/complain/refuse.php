...
<div class="after-sales-form">
    ...
    <?= $form->field($model, 'supplementary_reason')->textarea(['rows' => 4,'readonly'=>'readonly']) ?>

    <?= $form->field($model, 'store_refuse_reason')->textarea(['rows' => 4,'readonly'=>'readonly']) ?>
    <?= $form->field($model, 'store_refuse_reason1')->textarea(['rows' => 4]) ?>
