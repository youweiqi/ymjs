...
use common\components\excel\export\exceptions\ExportException;
...
class StandardModel extends BaseStandardModel
{
     ...
     * @inheritdoc
     */
    protected static $standardAttributeClassName = 'common\components\excel\export\basic\StandardAttribute';
