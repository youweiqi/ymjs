...
use backend\modules\order\models\search\WaitOrderSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * WaitOrderController implements the CRUD actions for OrderInfo model.
 */
class WaitOrderController extends Controller
{
    ...
    {
        $searchModel = new WaitOrderSearch();
